...
class PlantEditorRTDB extends StatefulWidget {
  final Map<String, dynamic> preExisting;
  final int cell;

  PlantEditorRTDB(this.preExisting, this.cell);

  @override
  _PlantEditorStateRTDB createState() => _PlantEditorStateRTDB();
}

class _PlantEditorStateRTDB extends State<PlantEditorRTDB> {
