...
class DetailedStatsRTDB extends StatefulWidget {
  final StatType statType;
  final int maxDataPoints;

  // TODO: also limit data by how recent the data is

  DetailedStatsRTDB(this.statType, {this.maxDataPoints = 50});

  @override
  _DetailedStatsStateRTDB createState() => _DetailedStatsStateRTDB();
}

class _DetailedStatsStateRTDB extends State<DetailedStatsRTDB> {
